...
<body class="pattern-bg">
    ...
    <div class="container">
                ...
                <form class="needs-validation" action="" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <label for="location">Choose location </label>
                            ...
                            <select name="location" id="location" class="btn btn-success location">
                                <option value=""></option>
        ...
        var shipping = $button.siblings().find("select#location").val();
       console.log(name,email,phone,address,city,zip,shipping);
      ...
      $.ajax({
        type:'POST',
        url:"{{ route('checkout') }}",
        data:{name:name, email:email, phone:phone, address:address, city:city, zip:zip, shipping:shipping},
